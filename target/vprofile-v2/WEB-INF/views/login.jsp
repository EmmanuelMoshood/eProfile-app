                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">Softech.io</a>
                            <i class="brand_network"><small><small>eProfile-app</small></small></i>
                        </div>
...
<div class="container">
    ...
    <form method="POST" action="${contextPath}/login" class="form-signin">
        <h2 class="form-heading" align="center" style="color: lightgrey;"> WELCOME </h2>
